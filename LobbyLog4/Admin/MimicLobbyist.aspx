<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MimicLobbyist.aspx.vb" Inherits="LobbyLog4.MimicLobbyist" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mimic Lobbyist</title>
<style type="text/css">
 .text {
 font-family:Calibri;
 font-size:22px;
...
<tr><td style="text-align:center; height:40px; font-family:Calibri; font-weight:bold; font-size:x-large; color:black;" colspan="3">Mimic a Lobbyist</td></tr>
